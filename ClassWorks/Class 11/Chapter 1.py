...
'''
It's worth nothing that the phone_numbers variable will always be a list, regardless of how many phone numbers are unpacked
including none. Thus, any code that uses phone_numbers won't have to account for the possibility tht it might not be a list 
or perform any kind of additional type checking.

The starred variable can also be the first one in the list. For example, say you have a sequence of values representng 
