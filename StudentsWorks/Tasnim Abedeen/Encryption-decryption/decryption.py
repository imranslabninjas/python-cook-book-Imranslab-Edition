# Hi there, I have built this decryption programme for any text encrypted via my encryption programme.
# Entry should contain exactly 26 english letter.
# Space and symbol are not currently supported by the programme.
message = str(input("Enter your text to decrypt exactly in 26 characters: "))
